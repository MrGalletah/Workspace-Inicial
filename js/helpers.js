...
function themeFunction() {
    ...
    themeButton.addEventListener("click", (e)=>{
        ...
        if(document.body.classList.contains("dark-theme")){
            saveTheme()
            darkThemeText.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-moon-fill m-1" viewBox="0 0 16 16">
            ...
            deleteTheme()
            darkThemeText.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-sun-fill m-1" viewBox="0 0 16 16">
