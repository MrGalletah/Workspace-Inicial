...
// Agregar productos al carro
  ...
  const productHTML = `
    ...
    <div class="col-1 text-center p-0 removeItem" title="Eliminar del carrito" data-productID="${productID}"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="red" class="bi bi-trash3 removeItem" viewBox="0 0 16 16">
