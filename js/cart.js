...
// Agregar productos al carro
  ...
  const productHTML = `
    ...
    <div class="col-6 col-sm-2 text-end text-sm-center fw-bold p-0" title="Eliminar del carrito" data-productID="${productID}"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="red" class="bi bi-trash3 removeItem" viewBox="0 0 16 16">
